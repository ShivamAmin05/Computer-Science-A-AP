...
public class Main {
  public static void main(String[] args) {
    PersonalAcct munozAccount = new PersonalAcct(250, "Maria", "Munoz",
        "110 Glades Road", "Mytown", "FL", "33445");
    BusinessAcct pizzaAccount = new BusinessAcct(600, "Antonio",
        "Oliverio", "5 Main Street", "Mytown", "FL", "33445");
    ...
    System.out.println("Balance is: " +
        money.format(pizzaAccount.getBalance()));
