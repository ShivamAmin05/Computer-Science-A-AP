...
/**
 * A car lot with cars, trucks, and minivans
 */
public class Main {
  /*
   * Returns a selected vehicle.
   * pre: none
   * post: An vehicle object has been returned.
   */
  ...
  public static void main(String[] args) {
    ...
    System.out.print("Learn about the Cargo area, see a vehicle Description, or Quit?(D for description Q for quit)");
